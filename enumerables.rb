...
def print_spicy_foods(spicy_foods)
  spicy_foods.map do |food|
    heat_level_num = food[:heat_level]
    heat_level_emoji = "🌶" * heat_level_num
...
def print_spiciest_foods(spicy_foods)
  list_spiciest = spiciest_foods(spicy_foods)
  print_spicy_foods(list_spiciest)
end
